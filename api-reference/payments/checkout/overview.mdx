  ...
  <Tab title="Inline Checkout SDK">
    ...
    <Steps>
      <Step title="Issue a checkout token (your backend)">
        ...
        - [Generate Checkout Token Here](/api-reference/payments/checkout/create-checkout-token)
      </Step>
...
```
        - [View Complete Implementation Here](/api-reference/payments/checkout/inline-checkout-sdk)
      </Step>
