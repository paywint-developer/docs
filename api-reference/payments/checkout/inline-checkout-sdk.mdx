...
The Paywint Inline Checkout SDK renders a managed checkout component inside your page. Your backend creates a short-lived [checkout token](/api-reference/payments/checkout/create-checkout-token), then your frontend passes that token to the SDK with the payment configuration.
