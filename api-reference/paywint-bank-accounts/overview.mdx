---
title: "Open Bank With Paywint"
description: "Open and manage Paywint–issued virtual bank accounts for your users."
icon: "building"
---

## Overview

Paywint Bank Accounts provide users with a verified virtual bank account issued directly by Paywint.  
...
<CardGroup cols={2}>
  <Card
    ...
    icon="external-link"
  >
    Create a new Paywint virtual bank account.
  </Card>
