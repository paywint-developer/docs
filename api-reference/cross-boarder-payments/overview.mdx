...
- Read **payee rules** so you collect the mandatory fields for each corridor
...
<Steps>
  ...
  <Step title="Check payer rules">
    Call [Get Payee Rules (Mandatory Fields)](/api-reference/cross-boarder-payments/get-payee-rules) to discover the
