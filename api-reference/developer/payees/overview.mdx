...
The **Developer Payee Management API** allows you to create and manage reusable recipient records for a specific Paywint user.
...
<CardGroup cols={3}>
  ...
  <Card title="Create Payee" icon="user-plus" href="/api-reference/developer/payees/create" arrow="true">
    Register a new payee before initiating a payment.
  </Card>

  <Card title="Update Payee" icon="pencil" href="/api-reference/developer/payees/update" arrow="true">
    Modify the payee name or associated metadata.
  </Card>

  <Card title="Get Payee" icon="user" href="/api-reference/developer/payees/get" arrow="true">
...
<CardGroup cols={3}>
  ...
  <Card title="List Payees" icon="list" href="/api-reference/developer/payees/list" arrow="true">
    Retrieve all payees associated with a user.
  </Card>

  <Card title="Delete Payee" icon="trash" href="/api-reference/developer/payees/delete" arrow="true">
...
<Steps>
  ...
  <Step title="1. Create a payee">
    Call <code>[Create Payee](/api-reference/developer/payees/create)</code> with the user ID, name, and contact details.
  </Step>
