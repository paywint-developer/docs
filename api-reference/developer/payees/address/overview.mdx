...
<CardGroup cols={3}>
  ...
  <Card title="Create Address" icon="plus-circle" href="/api-reference/developer/payees/address/create-address" arrow="true">
    Attach a new address to an existing payee.
  </Card>

  <Card title="List Addresses" icon="list" href="/api-reference/developer/payees/address/list-address" arrow="true">
    Retrieve all addresses associated with a payee.
  </Card>

  <Card title="Get Address" icon="map-pin" href="/api-reference/developer/payees/address/get-address" arrow="true">
...
<CardGroup cols={3}>
  ...
  <Card title="Update Address" icon="pencil" href="/api-reference/developer/payees/address/update-address" arrow="true">
    Modify an existing address record.
  </Card>

  <Card title="Set Default Address" icon="check-circle" href="/api-reference/developer/payees/address/set-default-address" arrow="true">
    Mark an address as the default address for the payee.
  </Card>

  <Card title="Delete Address" icon="trash" href="/api-reference/developer/payees/address/delete-address" arrow="true">
...
<Steps>
  ...
  <Step title="2. Create the address">
    Call <code>[Create Payee Address](/api-reference/developer/payees/address/create)</code> with properly formatted address fields.
  </Step>
