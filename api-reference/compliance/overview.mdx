...
<CardGroup cols={2}>
  <Card title="Submit KYC" icon="external-link" href="/api-reference/compliance/kyc/get-user-kyc-link" arrow="true">
    Retrieve a verification link to initiate or resume KYC for a user.
  </Card>
  
  <Card title="Get KYC Status" icon="list" href="/api-reference/compliance/kyc/get-user-kyc" arrow="true">
  ...
  <Tab title="Embedded (iFrame)">
    ...
    <Steps>
      <Step title="Call Submit KYC">
        Your backend calls  
        [Submit KYC](/api-reference/compliance/kyc/get-user-kyc-link)  
      ...
      <Step title="Fetch KYC">
        Your server calls [Get KYC](/api-reference/compliance/kyc/get-user-kyc) to retrieve verification details and status.
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="Hosted Page">
    ...
    <Steps>
      ...
      <Step title="Fetch updated KYC">
        Your server fetches the user’s updated verification details using [Get KYC](/api-reference/compliance/kyc/get-user-kyc).
      </Step>
    </Steps>
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="Submit KYB" icon="external-link" href="/api-reference/compliance/kyb/submit-user-kyb" arrow="true">
    Submit business information and mandatory supporting documents.
  </Card>
  
  <Card title="Get KYB Status" icon="list" href="/api-reference/compliance/kyb/get-user-kyb" arrow="true">
...
<Callout type="info" emoji="📄">
  ...
  See **[Document Upload Guidelines](/guidelines/url-standards)**  
</Callout>


<Steps>
  <Step title="Submit KYB">
    Make call to [Submit KYB](/api-reference/compliance/kyb/submit-user-kyb) with business information and document URLs.
  </Step>
  ...
  <Step title="Retrieve KYB record">
    Your server calls [Get KYB](/api-reference/compliance/kyb/get-user-kyb) to read the latest business verification data.
  </Step>
</Steps>
...
- Always store the user’s **Paywint User ID** before starting KYC/KYB.  
- Wallet-to-wallet transfers do **not** require KYC/KYB.  
